...
def index():
    ...
    return f'<link rel="stylesheet" href="../static/style.css"> <body><h1>Hola! en esta página verás datos aleatorios sobre la dependencia tecnológica</h1><a href="/random_fact">¡Ver un dato aleatorio!</a><a href="/cointoss">¡Lanza una moneda!</a></body>'
...
@app.route("/result")
def result():
    return f'<link rel="stylesheet" href="../static/style.css"><body><p>¡Salió {random.choice(["cara", "sello"])}!</p> <a href="/">Volver</a>'
app.run(debug=True)